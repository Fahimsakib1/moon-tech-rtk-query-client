...
const EditProduct = () => {
    ...
    const [editProduct, { isLoading, isSuccess, isError, error }] = useUpdateProductMutation();
    ...
    return (
        ...
        <div>
            <h1 className='text-center font-bold text-xl text-blue-600 mt-6'>Edit Product {model}</h1>
