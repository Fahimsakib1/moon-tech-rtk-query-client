...
import { getProducts, getSingleProduct, removeFromProductList, removeProduct, toggleDeleteSuccess } from "../../features/products/ProductSlice";
...
const ProductList = () => {
  ...
  const { products, isLoading, deleteSuccess, isError, error } = productsState
  ...
  }, [isLoading, deleteSuccess, isError, error, dispatch]);
